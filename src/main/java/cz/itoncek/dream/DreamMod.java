 ...
 *
 *    Keep the DreamModElements object in this class and all calls to this object
...
public class DreamMod {
	public static final Logger LOGGER = LogManager.getLogger(DreamMod.class);
	...
	public DreamModElements elements;
	public DreamMod() {
		elements = new DreamModElements();
